    ...
    <>
      {showModal && (
        <div id="snippetModal" className="active" onClick={closeModal}>
          <div className={`code-editor ${isSetup ? 'setup-mode' : ''}`} onClick={e => e.stopPropagation()}>
            <div className="code-header text-sm flex items-center gap-2">
              {isSetup ? (
                ...
                <span className="text-gray-400 mr-auto">フレームワークを使用しないhtml,cssの使用例です。シングルクラスの詳細度で上書きできます</span>
              )}
              {!isSetup && modalItems.length > 0 && modalItems[0] && modalItems[0].type === 'code' && (
                <button className="copy-btn" onClick={() => handleCopy(0, (modalItems[0] as ContentItem).content)}>
                  {copyStates[0] || 'Copy'}
                </button>
              )}
            ...
            <div className="code-content px-10 py-8 overflow-y-auto">
              {modalItems.map((item, index) => {
                ...
                return (
                  <div key={index} className={item.type === 'text' ? 'mb-6' : 'mb-8 relative group'}>
                    {title && (
                    ...
                    {item.type === 'text' ? (
                      ...
                      <div className="relative">
                        ...
                        <pre className="bg-black/50 p-6 rounded border border-gray-700 overflow-x-auto">
                          <code className="text-sm font-mono text-blue-300">{item.content}</code>
                        </pre>
                      </div>
                    )}
                  </div>
      ...
      {/* FlexRatio Preview */}
        <section className="mt-8" ref={flexRef}>
          <div className="py-2 flex justify-end flex-wrap gap-3 border-b-4 border-gray-400 border-solid">
            <h2 className="mr-auto mb-0 leading-none pt-1">FlexRatio
            </h2>
            <button 
      ...
      {/* Accordion Preview */}
        <section className=" wrapper into bg-green-100 mt-12" ref={accordionRef}>
          <div className="py-2 flex justify-end flex-wrap gap-3 border-b-4 border-gray-400 border-solid">
            <h2 className="mr-auto mb-0 leading-none pt-1">Accordion
            </h2>
            <button 
        ...
        <div className="mt-6">
          <h3 className="">2. className="accordion is_qa mt-3"</h3>
          <Accordion 
        ...
        <div className="mt-6">
          <h3 className="">3. className="accordion is_qa mt-3"</h3>
          <Accordion 
            className="is_qa mt-3"
      ...
      {/* Panel Preview */}
        <section className="mt-12" ref={panelRef}>
          <div className="py-2 flex justify-end flex-wrap gap-3 border-b-4 border-gray-400 border-solid">
            <h2 className="mr-auto mb-0 leading-none pt-1">Panel
            </h2>
            <button 
        ...
        <div className="mt-6">
          <h3 className="">1. className="panel is_flow img20 mt-3"</h3>
          <Panel className="is_flow img20 mt-3">
            <Panel.Item 
            className=""
              figure={<img src="https://picsum.photos/id/103/400/300" alt="" />}
            >
            ...
            <Panel.Item 
            className="is_rev "
              figure={<img src="https://picsum.photos/id/104/400/300" alt="" />}
            >
      ...
      {/* ImgText Preview */}
        <section className="wrapper into bg-purple-100 mt-12" ref={imgTextRef}>
          <div className="py-2 flex justify-end flex-wrap gap-3 border-b-4 border-gray-400 border-solid">
            <h2 className="mr-auto mb-0 leading-none pt-1">ImgText
            </h2>
            <button 
        ...
        <div className="mt-6">
          <ImgText
            ...
            figure={<img src="https://picsum.photos/id/10/400/300" alt="" />}>
          <h3 className="">1. className="img_text bp-sm mt-3"</h3>
        ...
        <div className="mt-6">
          <ImgText 
            ...
            figure={<img src="https://picsum.photos/id/20/400/300" alt="" />}
          >
          <h3 className="">2. className="img_text bp-sm img30 is_rev mt-3"</h3>
            <p>画像30%指定かつ左右反転 </p>
          </ImgText>
        </div>
      </section>
      ...
      {/* Cards Preview */}
        <section className="mt-12" ref={cardsRef}>
          <div className="py-2 flex justify-end flex-wrap gap-3 border-b-4 border-gray-400 border-solid">
            <h2 className="mr-auto mb-0 leading-none pt-1">Cards
            </h2>
            <button 
        ...
        <div className="mt-6">
          <h3 className="">1. className="cards col3 justify-center mt-3"</h3>
          <Cards className="col3 justify-center mt-3">
            {[1, 2, 3].map(i => (
              <CardItem className="sheet" key={i} figure={<img src="https://picsum.photos/id/10/400/250" alt="" />} >
                <h4>Card {i}</h4>
        ...
        <div className="">
          <h3 className="mt-6">2. className="cards col4 min2 justify-center mt-3"</h3>
          <Cards className="col4 min2 justify-center mt-3">
            {[1, 2, 3, 4].map(i => (
              <CardItem  className="board" key={i} figure={<img src="https://picsum.photos/id/20/400/250" alt="" />}>
                <h4>Card {i}</h4>
        ...
        <div className="mt-6">
          <h3 className="">3. className="cards col3 is_layer justify-center mt-3"</h3>
          <Cards className="col3 is_layer justify-center mt-3">
            {[1].map(i => (
              <CardItem 
              className="" key={i} figure={<img src="https://picsum.photos/id/30/600/600" alt="" />}>
                <div className="bg-black/50 text-white p-5 flex flex-col justify-center items-center ">
                  <h4 className="text-white">Layer {i}</h4>
        ...
        <div className="mt-6">
          ...
          <Cards className="colflex  mt-3">
            {[1, 2, 3].map(i => (
              <CardItem className="bg-gray-100 p-4 rounded" key={i} figure={""}>
                <h4>Flexible {i}</h4>
                <p>均等に広がります</p>
              </CardItem>
            ))}
        ...
        <div className="mt-6">
          <h3 className="">5. className="cards colfix" style="--itemW: 200px" </h3>
