		...
		<div className="bg-white text-gray-900">
			...
			<main className="py-[var(--head)] PX" id="contents">
				...
				<section className="wrapper into bg-purple-100">
					...
					<div className="mt-6">
						<ImgText
							className="has_img bp-sm img30 is_rev mt-3"
							figure={
								<img
					...
					<div className="mt-6">
						...
						<Cards className="col3 is_layer justify-center mt-3">
							{[1, 2, 3].map((i) => (
								...
								>
									<div
										className={`bg-black/50 text-white p-5 flex flex-col justify-center items-center ${
											i === 2
												? "self-center"
												: i === 3
												? "self-end"
