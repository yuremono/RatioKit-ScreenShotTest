 ...
 * HtmlPreview.htmlと同じカタログ内容を表示します
 */
const App: React.FC = () => {
  return (
      ...
      <main className="py-[--head] PX" id="contents">
        ...
        <section className="mt-8">
          ...
          <div className="mt-6">
            ...
            <div className="flex73 bp-sm mt-3">
        ...
        {/* Accordion Preview */}
        <section className="wrapper into bg-green-100">
          <div className="py-2 flex justify-end flex-wrap gap-3 border-0 border-b-4 border-gray-400 border-solid">
          ...
          <div className="mt-6">
            ...
            <Accordion className="is_qa mt-3" title="画像付きの質問です" figure={<img src="https://picsum.photos/id/60/400/300" alt="" />}>
        ...
        {/* ImgText Preview */}
        <section className="wrapper into bg-purple-100">
          <div className="py-2 flex justify-end flex-wrap gap-3 border-0 border-b-4 border-gray-400 border-solid">
            <h2 className="mr-auto mb-0 leading-none pt-1">ImgText</h2>
          </div>
          <div className="mt-6">
            <ImgText className="has_img bp-sm mt-3" figure={<img src="https://picsum.photos/id/10/400/300" alt="" />}>
          ...
          <div className="mt-6">
            <ImgText className="has_img bp-sm img30 is_rev mt-3" figure={<img src="https://picsum.photos/id/20/400/300" alt="" />}>
        ...
        <section className="">
          ...
          <div className="mt-6">
            ...
            <Cards className="col3 justify-center mt-3">
              {[1, 2, 3].map((i) => (
                <CardItem className="has_img sheet" key={i} figure={<img src="https://picsum.photos/id/10/400/250" alt="" />}>
                  <h4>Card {i}</h4>
          ...
          <div className="mt-6">
            <h3 className="">2. className="cards col4 min2 justify-center mt-3"</h3>
            <Cards className="col4 min2 justify-center mt-3">
              {[1, 2, 3, 4].map((i) => (
                <CardItem className="has_img board" key={i} figure={<img src="https://picsum.photos/id/20/400/250" alt="" />}>
                  <h4>Card {i}</h4>
          ...
          <div className="mt-6">
            ...
            <Cards className="col3 is_layer justify-center mt-3">
              {[1, 2, 3].map((i) => (
                <CardItem className="has_img" key={i} figure={<img src="https://picsum.photos/id/30/600/600" alt="" />}>
                  <div className={`bg-black/50 text-white p-5 flex flex-col justify-center items-center ${i === 2 ? 'self-center' : i === 3 ? 'self-end' : ''}`}>
                    <h4 className="text-white">Layer 1</h4>
